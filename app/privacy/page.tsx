        ...
        <article className="max-w-3xl mx-auto px-6">
          ...
          <section aria-labelledby="info">
            ...
            <ul className={UL}>
              ...
              <li>
                פנייה באמצעות קישורי WhatsApp או חיוג טלפוני ישירים מתבצעת מחוץ
                לאתר, וכפופה למדיניות הפרטיות של אותם שירותים.
              </li>
            </ul>
          </section>

          <section aria-labelledby="quote-form">
            <h2 id="quote-form" className={H2}>
              טופס קבלת הצעת מחיר
            </h2>
            <p className={P}>
              בעמוד{" "}
              ...
              ניתן למלא טופס פנייה. בעת השליחה נאספים הפרטים הבאים שאתם מזינים:
              שם מלא, מספר טלפון, עיר או יישוב, ותיאור קצר של התקלה החשמלית.
            </p>
            <p className={P}>
              המידע נשמר באופן מאובטח במסד הנתונים שלנו ב-
              <strong className="text-slate-900">Supabase</strong>, ומקושר לסשן
              הטכני של הגלישה באתר — לרבות מזהה מבקר ומזהה קליק של Google Ads
              (GCLID), ככל שהם קיימים — לצורך אבטחה, מניעת הונאות קליקים
              (Click Fraud) ומעקב שיווקי תקין.
            </p>
            <p className={P}>
              לאחר הרישום נשלחת התראת מערכת (Pushover) אל הטלפון של בעל העסק,
              כדי שנוכל לחזור אליכם במהירות. רק לאחר מכן מועברים לוואטסאפ עם
              הודעה מוכנה מראש הכוללת את הפרטים שהזנתם. השימוש בוואטסאפ עצמו
              כפוף למדיניות הפרטיות של WhatsApp / Meta.
            </p>
            <p className={P}>
              המידע משמש אך ורק לטיפול בפנייה ולמתן שירות חשמל. לא נמכור ולא
              נעביר את פרטיכם לצד שלישי למטרות שיווק שאינן קשורות לשירות זה.
            </p>
          </section>

          <section aria-labelledby="cookies">
            <h2 id="cookies" className={H2}>
              שימוש בעוגיות (Cookies) ושירותי צד שלישי
            </h2>
            <p className={P}>
              האתר עושה שימוש בקובצי עוגיות (Cookies) ובמערכות של צדדים שלישיים, לרבות שירותי{" "}
              <strong className="text-slate-900">Google Ads</strong> ו-<strong className="text-slate-900">Google Analytics</strong>,
              לצורך תפעולו השוטף, שיפור חוויית המשתמש, איסוף נתונים סטטיסטיים אנונימיים,
              והצגת מודעות מותאמות אישית ברחבי הרשת (Remarketing).
              שירותים אלו עשויים לאסוף נתונים כגון כתובת ה-IP שלך, סוג הדפדפן ודפוסי הגלישה באתר.
              בעצם השימוש והגלישה באתר, הנך נותן את הסכמתך המלאה לאיסוף ולשימוש בנתונים אלו.
              באפשרותך לשנות את הגדרות הפרטיות בדפדפן שלך ולחסום את השימוש בעוגיות בכל עת.
            </p>
          </section>
          ...
          <section aria-labelledby="storage">
            ...
            <p className={P}>
              האתר מאוחסן בשרת אחסון מאובטח. נתונים טכניים שאינם אישיים, כגון
              זמני גלישה וכתובות IP, נשמרים על ידי ספק האחסון למטרות אבטחה
              ותפעול. פרטי פניות מטופס הצעת המחיר נשמרים במסד נתונים מאובטח
              ב-Supabase, כמפורט בסעיף &quot;טופס קבלת הצעת מחיר&quot; לעיל.
            </p>
          </section>
