        ...
        <article className="max-w-3xl mx-auto px-6">
          ...
          <section aria-labelledby="quote-form">
            <h2 id="quote-form" className={H2}>
              טופס יצירת קשר והצעת מחיר
            </h2>
            <p className={P}>
              כאשר אתם פונים אלינו דרך טופס הצעת המחיר באתר, אנו אוספים את
              הפרטים שהזנתם (שם, טלפון, עיר ותיאור התקלה) כדי שנוכל לחזור
              אליכם עם מענה מדויק ומהיר.
            </p>
            <p className={P}>
              למטרות אבטחת האתר, שיפור השירות והבנת מקורות ההגעה אלינו, פרטי
              הפנייה נשמרים בסביבה מאובטחת ועשויים להיות מקושרים לנתונים
              טכניים של הגלישה.
            </p>
            <p className={P}>
              לאחר שליחת הטופס, תועברו אוטומטית לוואטסאפ שלנו להמשך השיחה
              בנוחות. הפרטים שלכם נשארים אצלנו בלבד ומשמשים אך ורק למתן
              השירות אליו פניתם, ולעולם לא יועברו לצד שלישי.
            </p>
          </section>
          ...
          <section aria-labelledby="storage">
            ...
            <p className={P}>
              ...
              ותפעול. פרטי פניות מטופס הצעת המחיר נשמרים בסביבה מאובטחת,
              כמפורט בסעיף &quot;טופס יצירת קשר והצעת מחיר&quot; לעיל.
            </p>
          </section>
