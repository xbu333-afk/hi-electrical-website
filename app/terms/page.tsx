    ...
    <>
      ...
      <div className="bg-slate-50 py-10 md:py-14">
        <article className="mx-auto max-w-3xl px-6">
          ...
          <section aria-labelledby="reviews-feedback">
            <h2 id="reviews-feedback" className={H2}>
              המלצות ומשובי לקוחות
            </h2>
            <p className={P}>
              האתר עשוי לכלול המלצות, חוות דעת ומשובים שהתקבלו מלקוחות לאורך שנות
              פעילות העסק ובערוצים שונים, לרבות פלטפורמות חיצוניות, הודעות
              כתובות, אמצעי תקשורת דיגיטליים, פניות ישירות ומשובים שנמסרו לעסק.
            </p>
            <p className={P}>
              המלצות ומשובים המוצגים באתר נועדו לשקף התרשמות וחוויות של לקוחות
              כפי שנמסרו לעסק או פורסמו בערוצים שונים. אין בהצגת המלצה או משוב
              מסוים כדי להבטיח תוצאה זהה או דומה בכל מקרה אחר.
            </p>
            <p className={P}>
              ככל שמוצג באתר תיאור כללי של היקף ההמלצות או המשובים, כגון
              &quot;מאות המלצות ומשובי לקוחות&quot;, מדובר בנתון מצטבר המתייחס
              למשובים ולהמלצות שהתקבלו לאורך זמן ובערוצים שונים, והוא אינו
              מתיימר לשקף את מספר הביקורות הפומביות הזמינות במועד נתון בפלטפורמה
              חיצונית מסוימת.
            </p>
          </section>
