...
import ArticleProfessionalDisclaimer from "@/app/components/ArticleProfessionalDisclaimer";
...
type ArticleVideoCtaProps = {
  ...
  callPurpose: string;
  /**
   * מציג הבהרה מקצועית מעל בלוק ההמרה.
   * ברירת מחדל: true (מאמרים). כבוי בעמודי ערים / דפי המרה שאינם מאמר.
   */
...
export default function ArticleVideoCta({
  ...
  return (
    <>
      {showDisclaimer ? <ArticleProfessionalDisclaimer /> : null}
