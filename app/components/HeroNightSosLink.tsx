...
export default function HeroNightSosLink({ locale = "he" }: { locale?: UiLocale }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center justify-center gap-1.5 w-full min-h-[2.75rem] py-2.5 text-xs font-semibold text-red-600 bg-red-50 border border-red-100 hover:bg-red-100 rounded-xl transition-colors"
