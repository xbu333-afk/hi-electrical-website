...
export const UI_LABELS: Record<UiLocale, UiLabels> = {
  he: {
    ...
    services: [
      ...
      { id: "reconnect", label: "חיבור מחדש ובדיקת תקינות לאחר ניתוק" },
      { id: "grounding", label: "בדיקות הארקה ובטיחות" },
    ],
  ...
  ru: {
    ...
    services: [
      ...
      { id: "reconnect", label: "Повторное подключение и проверка после отключения" },
      { id: "grounding", label: "Проверка заземления и безопасности" },
    ],
